...
//    options = $.extend(settings, options);
    ...
    $(document).on('click', '#calculate-btn', function(e){
        e.preventDefault();
        $('#results').hide()
            .html('Monthly Payment <strong>$' + calculate() + '</strong>')
            .show();
    });
    ...
    */
    ...
    function returnOutput()
    {
        ...
        // Submit Button
        out += "<button type='submit' class='btn btn-primary btn-block' id='calculate-btn'>Calculate</button></form>";
